...
export const amenityIcons: { [key: string]: React.ReactNode } = {
  ...
  Microphone: <Presentation className="w-4 h-4" />,
  "LCD Projector": <Presentation className="w-4 h-4" />,
  Stage: <Building2 className="w-4 h-4" />,
  "Air Conditioning": <Building2 className="w-4 h-4" />,
  Tables: <Building2 className="w-4 h-4" />,
  Chairs: <Building2 className="w-4 h-4" />,
